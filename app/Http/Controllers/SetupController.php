...
class SetupController extends Controller
{
    ...
    public function company_create()
    {
        try {
            ...
            $country = Setup_Details::get('country');

            return view('Setup.company', compact('state', 'country'));
        } catch (\Exception $e) {
    ...
    public function company_list()
    {
        try {
            ...
            // Handle exceptions
            return redirect()->back()->with('error', 'Error occurred while fetching company list: ' . $e->getMessage());
        }
    }
    ...
    public function company_edit($id)
    {
        try {
            ...
            $state = Setup_Details::get('state');
            return view('Setup.company_edit', compact('company', 'state'));
        } catch (\Exception $e) {
            // Handle exceptions
    ...
    public function company_update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('comapny_list')->with('info', 'Company Updated Successfully');
        } catch (\Exception $e) {
            // Handle exceptions
    ...
    {
        try {
            $divisions = Setup_Division::with('company')->where('flag', 0)->get();
    ...
    public function division_update(Request $request, $id)
    {
        try {
            ...
            if ($existingDivision) {
                ...
                return redirect()->route('division_create')->with('warning', 'Division already exists.');
            }
    ...
    public function division_delete($id)
    {
        try {
            ...
            if ($linkedUnits || $linkedRegions) {
                return redirect()->route('division_create')->with('warning', 'Division is linked to units or regions so cannot be deleted.');
            }
    ...
    public function unit_store(Request $request)
    {
        try {
            ...
            if ($unitExists) {
                ...
                return redirect()->route('unit_create')->with('info', 'Unit already exists.');
            }
            ...
            Setup_Unit::create([
                ...
                'BU' => 0,
                'division_fy_21_22' => $request->input('division'),
    ...
    public function unit_edit($id)
    {
        ...
        return view('Setup.unit_edit', compact(['unit', 'division']));
    }
    ...
    public function unit_update(Request $request, $id)
    {
        try {
            ...
            if ($existingUnit) {
                ...
                return redirect()->route('unit_create')->with('warning', 'Unit already exists.');
            }
            ...
            $unit->update([
                ...
                'unit' => $request->input('unit'),
                'BU' => 0,
                'division_fy_21_22' => $request->division,
            ]);

            // Redirect back to the unit create page with a success message
            return redirect()->route('unit_create')->with('info', 'Unit has been updated successfully');
        } catch (\Exception $e) {
    ...
    public function unit_delete($id)
    {
        try {
            // Check if the division is linked to units or regions where the flag is 0
            $linkeddivision = Setup_Division::where('id', $id)->where('flag', 0)->exists();
            $linkedRegions = Setup_Region::where('division_id', $id)->where('flag', 0)->exists();

            // If linked records exist in either units or regions where the flag is 0, prevent deletion
            if ($linkeddivision || $linkedRegions) {
                return redirect()->route('unit_create')->with('warning', 'Unit is linked to Division or regions so cannot be deleted.');
            }

            // If no linked records exist, proceed with deleting the division
            $division = Setup_Unit::find($id);
            $division->update([
                'flag' => 1,
                'updated_at' => now(),
            ]);
    ...
    public function Setup_region_store(Request $request)
    {
        try {
            ...
            if ($regionExists) {
                return redirect()->route('region_create')->withInput()->with('warning', 'Division already exists.');
            }
    ...
    public function region_edit($id)
    {
        try {
            ...
            $company = Setup_Region::with('company')->get();
    ...
    public function region_delete($id)
    {
        try {
            // Check if the division is linked to units or regions where the flag is 0
            $linkeddivision = Setup_Division::where('id', $id)->where('flag', 0)->exists();
            $linkedunit = Setup_Unit::where('division_id', $id)->where('flag', 0)->exists();
    ...
    public function checkUniqueUserId(Request $request)
    {
        try {
            ...
            $user = Setup_User::where('user_id', $userId)->first();
    ...
    {
        try {
            $user = Setup_User::where('flag', 0)->get();
    ...
    public function user_update(Request $request, $id)
    {
        try {
            ...
            $existingUser = Setup_User::where('email_id', $request->input('email_id'))
            ...
            if ($existingUser) {
                // Redirect back with a warning message if flag is true
                return redirect()->route('Setup_user_list')->with('warning', 'Unit already exists.');
            }
            // Update user data
