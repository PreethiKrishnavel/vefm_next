                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="hidden" class="form-control" name="company"
                                    value="{{$unit->company->id}}">
                                <input type="text" class="form-control" value="{{$unit->company->company_name}}"
                                    readonly>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label>Division</label>
                                <select class="form-control" id="" name="division"  readonly>
                                    <option selected value="{{$unit->division->id}}">{{$unit->division->division_name}}
                                    </option>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="unit" value="{{$unit->unit}}" pattern="[ .a-zA-Z0-9]+" title="Only letters, spaces, and numbers are allowed"  disabled required>
                            </div>
