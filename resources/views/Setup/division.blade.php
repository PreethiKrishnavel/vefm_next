                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                @else
                                    ...
                                    <input type="hidden" name="company_id" id="company_id" value="{{ $companies->first()->id }}">
                                @endif
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="division" >Division<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" autocomplete="off" value="{{ old('division') }}" id="division" pattern="[ .a-zA-Z0-9]+" title="Only letters, spaces, and numbers are allowed" name="division" required>
                           </div>
                           <div class="col-md-3 mb-3">
                            <label for="division_code">Division Code <span style="color: red;">*</span></label>
                            <input type="text" class="form-control"  autocomplete="off"  value="{{ old('division_code') }}" id="division_code" pattern="[ .a-zA-Z0-9]+" title="Only letters, spaces, and numbers are allowed" name="division_code"  required>
                       </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $division->company ? $division->company->company_name : 'N/A' }}</td>
                                                <td><u><a href="{{url('Setup_division_edit/'.$division->id)}}">{{$division->division_name}}</u></td>
                                                <td>{{$division->division_code}}</td>
                                                <td>
                                                    <a href="{{url('Setup_division_delete/'.$division->id)}}"><i class="ti-trash" onclick="return confirm('Are You Sure')"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
