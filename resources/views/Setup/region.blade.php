                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <div class="col-md-2 mb-3">
                        ...
                        <input type="text" class="form-control"  name="region_code"  value="{{ old('region_code') }}"  pattern="^[0-9]*$"
                        autocomplete="off" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="Only numbers allowed"required>
                   </div>

                   <div class="col-md-2 mb-3">
                    <label >Invoice Code<span style="color: red;">*</span></label>
                    <input type="text" class="form-control"  name="invoice_code" value="{{ old('region_code') }}"  pattern="^[0-9]*$"
                    autocomplete="off" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="Only numbers allowed" required >
               </div>
               <div class="mb-2">
                <div class="row">
