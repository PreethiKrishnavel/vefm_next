            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <div class="m-r-5">
                       <a href="{{route('comapny_create')}}"> <button type="button" class="btn btn-outline-primary btn-uppercase waves-effect waves-button waves-light" style="margin-left:700px;">
                    ...
                    <div class="table-responsive" style="overflow-x: auto; overflow-y: scroll; max-height: 400px;">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><u><a href="{{url('Setup_company_edit/'.$company->id)}}">{{$company->company_name}}</u></a></td>
