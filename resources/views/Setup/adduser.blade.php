                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control" id="person_role" name="person_role" required>
                                ...
                                <option value="all_division" {{ old('person_role') == 'all_division' ? 'selected' : '' }}>
                                    All Division</option>
                                <option value="super_user" {{ old('person_role') == 'super_user' ? 'selected' : '' }}>Super
                                    User</option>
                                <option value="user" {{ old('person_role') == 'user' ? 'selected' : '' }}>User</option>
                                <option value="unit_user" {{ old('person_role') == 'unit_user' ? 'selected' : '' }}>Unit
                                    User</option>
                                <option value="engineer" {{ old('person_role') == 'engineer' ? 'selected' : '' }}>Engineer
                                </option>
                            </select>
                        </div>
                            ...
                            <select class="form-control" id="division" name="division" required>
                                ...
                                @foreach ($division as $divisionItem)
                                    <option value="{{ $divisionItem->id }}"
                                        {{ old('division') == $divisionItem->id ? 'selected' : '' }}>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" id="regioncode" value="VE"
                                    name="jobno" readonly>
