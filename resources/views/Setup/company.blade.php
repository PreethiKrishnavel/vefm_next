                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            pattern="[ .a-zA-Z]+" title="Only letters and spaces are allowed" value="{{ old('company_name') }}"
                                required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Location<span style="color: red;">*</span></label>
                            <input type="text" class="form-control" pattern="[ .a-zA-Z]+" title="Only letters and spaces are allowed" name="location" value="{{ old('location') }}"
                                required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Address<span style="color: red;">*</span></label>
                            <textarea class="form-control" id="exampleFormControl" rows="3" name="address" pattern="[ .a-zA-Z0-9]+" title="Only letters, spaces, and numbers are allowed" required>{{ old('address') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="city" pattern="[ .a-zA-Z]+"  title="Only letters and spaces are allowed" value="{{ old('city') }}" required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control" id="country" name="country" required>
                                ...
                                @foreach ($country as $country)
                                    <option {{ old('country') == $country->country ? 'selected' : '' }}>{{ $country->country }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ old('telephone') }}" autocomplete="off"
                                onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="telephone" required>
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <button class="btn btn-success" type="submit" style="position: relative;left: 700px;">Submit</button>
