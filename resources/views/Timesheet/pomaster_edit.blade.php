                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                <label>Division<span style="color: red;">*</span></label>
                                    ...
                                    <input type="text" class="form-control" name="division" value="{{ $pomaster->division->division_name }}" readonly>

                            </div>

                            <div class="col-md-3 mb-3">
                                <label>Unit<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="unit" value="{{ $pomaster->unit->unit }}" readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label>Region<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="unit" value="{{ $pomaster->region->region_name}}" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" id="customer" name="customer" readonly required>
                                    ...
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->id }}" {{ $pomaster->customer_id == $customer->id ? 'selected' : '' }}>
                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                title="Only letters and spaces are allowed" value="{{ $pomaster->project_site }}" disabled required>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label>PO Number<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="po_number" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" value="{{ $pomaster->po_number }}" disabled required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label>PO Date<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="po_date" id="po_date" value="{{ $pomaster->po_date }}" disabled required>
                            </div>
                            
                            <div class="col-md-3 mb-3">
                                <label>PO Value<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="po_value" id="po_value" value="{{ $pomaster->po_value }}"
                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3" >
                                ...
                                <input type="text" class="form-control" name="consumed" id="consumed" value="{{ $pomaster->consumed }}"
                                    onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label>Balance</label>
                                <input type="text" class="form-control" name="balance" value="{{ $pomaster->balance }}" readonly>
                            </div>
                        </div>
