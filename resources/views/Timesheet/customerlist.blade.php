...
@section('content')
    <div class="container">
        ...
        <div class="page-header d-md-flex align-items-center justify-content-between">
            ...
            <div>
                <button type="button" class="btn btn-outline-primary btn-uppercase waves-effect waves-button waves-light" onclick="location.href='{{ route('setup_customer_create') }}'">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><u> <a href="{{url('Setup_customer_edit/'.$customer->id)}}">{{ $customer->customer_name }}</u></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('Setup_customer_delete/'.$customer->id)}}"> <i class="ti-trash"  onclick="return confirm('Are You Sure')"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
