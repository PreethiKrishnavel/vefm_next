                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email_id" id="email_id"
                                        pattern="[^@\s]+@[^@\s]+\.[^@\s]+" autocomplete="off" value="{{ old('email_id') }}"
                                        required>
                                ...
                                <div class="col-md-3 mb-3">
                                    <label>Eligible Allowances</label>
                                ...
                                <div class="col-md-3 mb-3">
                                    <label>Per Day Allowances</label>
                                    <input type="text" class="form-control" autocomplete="off"
                                        onkeypress='return event.charCode >= 48 && event.charCode <= 57'
            ...
            $('#engineer_ecode').on('input', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (!response.unique) {
                            $('#engineer_ecode_error').text('Engineer Ecode already exists');
                        } else {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(result.regions, function(key, value) {
                    regionDropdown.append('<option value="' + value.id + '">' + value.region_name + '</option>');
                });
