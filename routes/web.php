...
Route::get('/timesheetedit', function () {
    return view('timesheetedit');
});

Route::get('/butimesheet', function () {
    return view('butimesheet');
});

Route::get('/collection', function () {
    return view('collection');
});
Route::get('/collectionedit', function () {
    return view('collectionedit');
});
Route::get('/pomaster', function () {
...
Route::get('/pomasterlist', function () {
    return view('pomasterlist');
});

Route::get('/Bu-timesheet', function () {
    return view('Bu-timesheet');
});
...
Route::get('/Setup_company_edit/{id}', [SetupController::class,'company_edit']);
...
Route::post('/fetch_regions', [TimesheetController::class, 'fetchRegions']);
...
Route::get('/Setup_user_edit/{id}',[SetupController::class,'user_edit']);
